...
graph TD
    ...
    click B "./qkyd-admin/CLAUDE.md" "查看 admin 模块文档"
    click C "./qkyd-framework/CLAUDE.md" "查看 framework 模块文档"
    click D "./qkyd-system/CLAUDE.md" "查看 system 模块文档"
    click E "./qkyd-common/CLAUDE.md" "查看 common 模块文档"
    click F "./qkyd-health/CLAUDE.md" "查看 health 模块文档"
    click G "./qkyd-ai/CLAUDE.md" "查看 ai 模块文档"
    click H "./qkyd-quartz/CLAUDE.md" "查看 quartz 模块文档"
    click I "./qkyd-generator/CLAUDE.md" "查看 generator 模块文档"
    click J "./RuoYi-Vue3-Modern/CLAUDE.md" "查看前端模块文档"
```
