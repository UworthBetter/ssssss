...
<script>
import { listRate, getRate, delRate, addRate, updateRate } from "@/api/health/rate";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('health/rate/export', {
        ...this.queryParams
