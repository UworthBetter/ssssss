...
<script>
import { listTemp, getTemp, delTemp, addTemp, updateTemp } from "@/api/health/temp";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('health/temp/export', {
        ...this.queryParams
