...
print("=" * 60)
print("      MySQL - Add Week 2 Indexes")
print("=" * 60)
print()
...
try:
    ...
    # 2. Use database
    cursor.execute("USE qkyd_jkpt")
    conn.commit()
    print("[INFO] Database switched to qkyd_jkpt")
    print()

    # 3. Add Week 2 indexes
    ...
    print("  2. Database qkyd_jkpt does not exist")
