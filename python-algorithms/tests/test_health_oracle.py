...
class TestHealthOracle(unittest.TestCase):
    def setUp(self):
        self.scorer = HealthOracle()
    ...
    def test_high_risk_scenario(self):
        ...
        """
        print("\n--- Testing HealthOracle High Risk Scenario ---")
        data = {
            "heart_rate": 110, # Risk
        ...
        print(f"HealthOracle Says: {report.get('diagnosis_summary')}")
