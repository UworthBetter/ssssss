...
async def lifespan(app: FastAPI):
    ...
    print(f"[qkyd-ai-service] 服务启动完成")
    print(f"[qkyd-ai-service] 心率检测器: window_size=10, threshold=30%")
    print(f"[qkyd-ai-service] 健康风险预测器: {model_status}")
    
    yield
    
    # 关闭时清理资源
    print("[qkyd-ai-service] 服务正在关闭...")


# 创建 FastAPI 应用
app = FastAPI(
    title="QKYD AI Service",
    description="""
## 时序体征数据处理微服务
