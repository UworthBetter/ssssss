...
public class UeitExceptionController extends BaseController
{
    ...
    public TableDataInfo listByUserId(UeitException ueitException)
    {
        startPage();
        List<UeitException> list = ueitExceptionService.selectUeitExceptionListByUserId(ueitException);
        return getDataTable(list);
    }
    /**
     * 导出异常数据列表
